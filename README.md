...
- 💪🏻 O que eu domino:
- **Web:** HTML5, CSS3 (Grid/Flexbox/Posicionamento) e Sass.
- **Mobile:** React Native.
- **Design:** UI Design Avançado e Figma.
- **Ferramentas:** Git e GitHub.

- 🧠 Educação e Cursos:
- **Ciência da Computação** (Bacharelado) – GranCursos - 3/8.
- **React Native** (Foco em apps) – Presencial.
- **UI Design Avançado** – Origamid.
- **JavaScript Completo** – Origamid.
- **HTML/CSS Profissional** e **CSS Flexbox/Grid** – Origamid.
